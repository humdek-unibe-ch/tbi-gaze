...
namespace CustomCalibrate
{
    ...
    public partial class App : Application
    {
        ...
        private EyeTrackerPro? _tracker = null;
        ...
        private void OnApplicationStartup(object sender, StartupEventArgs e)
        {
            ...
            Current.MainWindow = new CalibrationWindow();
            Current.MainWindow.Content = new CalibrationCollection(_calibrationModel);

            if (_config.Config.MouseCalibrationHide)
            {
                Current.MainWindow.Cursor = Cursors.None;
            }
