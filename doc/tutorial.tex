...
This illustrated in Figure~\ref{fig.adcs}.
\begin{figure}[ht]
    \centering
    ...
    \label{fig.adcs}
\end{figure}
By default, the system is configured to log the x and y coordinates of the gaze point and the timestamp of when the gaze point was captured by the eye tracker.
