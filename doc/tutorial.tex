...
\begin{description}
    \item[code \texttt{10}] \hfill \\
        ...
        This can be cause by a malfunctioning of the eye tracker device or simply because the device was disconnected.
    ...
    \item[code \texttt{01}] \hfill \\
        ...
        Check the whether the license files are accessible by the system and whether the license path is correctly defined in parameter \texttt{"LicensePath"}.
\end{description}
